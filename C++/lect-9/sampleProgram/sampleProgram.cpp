...
class management : public College {
    ...
    public:
     ...
     void salaryPayment(){
        ...
        if(balance > 1000){
            balance = balance - payment;
            cout<<"current Balance in college : "<< balance;
        }else{
            cout<<"\n Insufficient balance  : "<<balance;
        }
     }
     void departmentCampaigns(){
        cout<<"Current Status : "<<"Btech Fare Well"<<endl;
     }
     void currentDisplay(){
...
int main(){
    ...
    char type;
    cout<<"Enter the student s or Teacher t or College c enter single character:"<<endl;
    cin>>type;
